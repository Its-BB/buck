...
const GROUP_ID = 35737951; // Replace with your group ID
...
const LOG_FILE = 'promotion_log.json'; // File to store failed promotions
...
app.post('/promote', async (req, res) => {
    ...
    try {
        ...
        // Log failed promotion (e.g., cookie expired, permissions)
